...
namespace ToolsApp.Authentication
{
    public class CustomAuthorizeAttribute : AuthorizeAttribute
    {
        ...
        public override void OnAuthorization(AuthorizationContext filterContext)
        {
            ...
            {
                using (var _db = new ToolsApp.EntityFramework.ChamCong_teamdevEntities())
                {
                    var user_fun = _db.AspNetUsers.FirstOrDefault(p => p.UserName == CurrentUser.UserName && p.AccoutType == "Admin");
